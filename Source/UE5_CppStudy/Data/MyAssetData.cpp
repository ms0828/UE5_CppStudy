...
void UMyAssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UMyAssetData::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UMyAssetData::GetAssetSetByLabel(const FName& Label)
{
